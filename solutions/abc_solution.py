...
class BaseSolution(abc.ABC):
    ...
    def get_l2_penalty(self):
        # if not hasattr(self, '_l2_coefficents'):
        #     raise ValueError('_l2_coefficient not specified')
        params = self.get_params()
        print(self._l2_coefficient)
    ...
    def add_noise_to_layer(self, noise, layer_index):
        ...
        self.set_params_to_layer(params= layer_params+ noise, layer_index=layer_index)